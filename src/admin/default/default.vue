<template>
    ...
    <div class="default">
        ...
        <el-row>
            <div class="" id="charCloudDemo" style="width: 100%; height: 800px"></div>
        </el-row>
    ...
    export default {
        ...
        methods: {
            drawCharts(id, opts) {
                ...
                let myChart = this.$echarts.init(document.getElementById(id), 'shine');
                // 绘制图表
        ...
        mounted() {
            this.drawCharts('barDemo', this.barOpts);
            this.drawCharts('pieDemo', this.pieOpts);

            let _this = this;
            _this.charCloudOpts.series[0].data = _this.$util.objToArr(_this.words);
            let maskImage = new Image();
            // maskImage.src = 'https://raw.githubusercontent.com/ecomfe/echarts-wordcloud/master/example/logo.png';
            maskImage.onload = function () {
                _this.charCloudOpts.series[0].maskImage = maskImage;
                console.log(_this.charCloudOpts, 496)
                console.log(maskImage.width)
            };
            _this.drawCharts('charCloudDemo', _this.charCloudOpts);
        }
    }
</script>
