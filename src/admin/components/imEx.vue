...
<template>
    <div class="imEx" v-loading.fullscreen.lock="fullscreenLoading" element-loading-text="拼命加载中...">
    ...
    export default {
        ...
        methods: {
            ...
            downloadFile: function (rs) { // 点击导出按钮
                ...
                data = data.concat(rs);
                this.downloadExl(data, Date.now());
            },
            ...
            dealFile: function (data) {   // 处理导入的数据
                ...
                if (data.length <= 0) {
                    ...
                    this.excelData = data.concat(this.excelData);
                }
            },
